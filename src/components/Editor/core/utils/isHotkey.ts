import { isFunction, isNumber, isString } from ".";
...
export function isHotkey(keyFilter: KeyFilter, event: KeyboardEvent): boolean {
  const genGuard = genKeyFormatter(keyFilter, true);
