...
type PickPluginType<key extends keyof EditorPlugin> =
  Required<EditorPlugin>[key] extends AnyFn
...
export type CallerMap = {
  ...
  [CALLER_TYPE.WILL_SET_CLIPBOARD]: PickPluginType<
    typeof CALLER_TYPE.WILL_SET_CLIPBOARD
  >;
  [CALLER_TYPE.WILL_PASTE_NODES]: PickPluginType<
    typeof CALLER_TYPE.WILL_PASTE_NODES
  >;
};
